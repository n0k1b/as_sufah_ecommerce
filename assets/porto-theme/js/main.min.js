    ...
    var t = {
        ...
        stickyHeader: function() {
            if (e(".sticky-header").length) {
                ...
                if (!e(".header-bottom").find(".logo").length) {
                    var t = e(".header-bottom").find(".container .header-left");
                    e(".header").find(".logo").clone(!0).prependTo(t)
                }
            }
            e("main").find(".sticky-header").each(function() { new Waypoint.Sticky({ element: e(this), stuckClass: "fixed-nav" }) })
        },
        headerSearchToggle: function() { e(".search-toggle").on("click", function(t) { e(".header-search .submit-wrapper").toggleClass("show"), t.preventDefault() }), e("body").on("click", function(t) { e(".header-search .submit-wrapper").hasClass("show") && (e(".header-search .submit-wrapper").removeClass("show"), e("body").removeClass("is-search-active")) }), e(".header-search").on("click", function(e) { e.stopPropagation() }) },
        ...
        mobileMenu: function() {
            e(".mmenu-btn").on("click", function(t) {
                var o = e(this).closest("li"),
                    i = o.find("ul").eq(0);
                o.hasClass("open") ? i.slideUp(300, function() { o.removeClass("open") }) : i.slideDown(300, function() { o.addClass("open") }), t.stopPropagation(), t.preventDefault()
            })
        },
        ...
        lightBox: function() {
            ...
            i.each(function() { o.push({ src: e(this).attr("data-zoom-image") }) }), e(".prod-full-screen").click(function(t) {
                var n;
                n = t.currentTarget.closest(".product-slider-container") ? (e(".product-single-carousel").data("owl.carousel").current() + i.length - Math.ceil(i.length / 2)) % i.length : e(t.currentTarget).closest(".product-item").index(), e.magnificPopup.open({ items: o, navigateByImgClick: !0, type: "image", gallery: { enabled: !0 } }, n)
                ...
                setTimeout(function() {
                    e.magnificPopup.open({
                        ...
                        callbacks: {
                            ...
                            ajaxContentAdded: function() { t.owlCarousels(), t.quantityInputs(), "undefined" != typeof addthis ? addthis.layers.refresh() : e.getScript("https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b927288a03dbde6") },
                            beforeClose: function() { e(".ajax-overlay").remove() },
                            afterClose: function() {
                                if (e(".sticky-header.fixed").css("margin-right")) {
                                    var t = Number(e(".sticky-header.fixed").css("margin-right").slice(0, -2)) - 17 + "px";
                                    e(".sticky-header.fixed").css("margin-right", t), e(".sticky-header.fixed-nav").css("margin-right", t), e("#scroll-top").css("margin-right", t)
        ...
        ajaxLoadProduct: function() {
            ...
            o.click(function(i) {
                i.preventDefault(), e(this).text("Loading ..."), e.ajax({
                    ...
                    success: function(i) {
                        var n = e(i);
                        setTimeout(function() { n.hide().appendTo(".product-ajax-grid").fadeIn(), o.text("Load More"), ++t >= 2 && o.hide() }, 350)
                    },
        ...
        scrollToElement: function() {
            e('.scrolling-box a[href^="#"]').on("click", function(t) {
                ...
                o.length && (t.preventDefault(), e("html, body").stop().animate({ scrollTop: o.offset().top - 90 }, 700))
            })
        },
        loginPopup: function() {
        ...
        productManage: function() { e(".product-select").click(function(t) { e(this).parents(".product-default").find("figure img").attr("src", e(this).data("src")), e(this).addClass("checked").siblings().removeClass("checked") }) },
        ...
        isotopes: function() { e(".grid").isotope({ itemsSelector: ".grid-item", layoutMode: "packery", percentPosition: !0 }) },
