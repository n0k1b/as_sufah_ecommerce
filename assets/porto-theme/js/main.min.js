    ...
    var t = {
        ...
        headerSearchToggle: function() {
            e(".search-toggle").on("click", function(t) {
                e(".header-search .submit-wrapper").toggleClass("show"), t.preventDefault()
            }), e("body").on("click", function(t) {
                e(".header-search .submit-wrapper").hasClass("show") && (e(".header-search .submit-wrapper").removeClass("show"), e("body").removeClass("is-search-active"))
        ...
        lightBox: function() {
            ...
            i.each(function() {
                ...
                var n;
                n = t.currentTarget.closest(".product-slider-container") ? (e(".product-single-carousel").data("owl.carousel").current() + i.length - Math.ceil(i.length / 2)) % i.length : e(t.currentTarget).closest(".product-item").index(), e.magnificPopup.open({
                    items: o,
