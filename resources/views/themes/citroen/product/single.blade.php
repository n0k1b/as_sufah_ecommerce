            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xs-12">
                                            ...
                                            @if (count($product->images) > 0)
                                                <div class="product-image">
                                                    <div class="product-full"> <img id="product-zoom"
                                                            ...
                                                            data-zoom-image="{{ asset($product->thumbnail_image) }}"
                        ...
                        <p class="rating-links"> <a href="#">453 ratings &amp; 61 reviews</a> <span class="separator">|</span> <a href="#">Add Review</a> </p>
                        </div> --}}
                                            <div class="price-block">
                                                <div class="price-box">
                                                    @if ($product->stock->stock_amount !== null)
                                ...
                                {{-- <div class="product-collateral">
                                    <div class="add_info">
                                        <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                            ...
                                            <li> <a href="#product_tabs_custom1" data-toggle="tab">Questions & Answers</a>
                                            </li>
                                        </ul>
                                        <div id="productTabContent" class="tab-content">
                                            <div class="tab-pane fade in active" id="product_tabs_description">
                                                <div class="std">
                                                    ...
                                                    <p>The keyboard offers a comfortable typing experience, thereby
                                                        minimizing the load on your hands while working. Aliquam laoreet
                                                        consequat malesuada. Integer vitae diam sed dolor euismod laoreet
                                                        eget ac felis. Donec non erat sed elit bibendum sodales. Donec eu
                                                        cursus velit. Proin nunc lacus, gravida mollis dictum ut, vulputate
                                                        eu turpis. Sed felis sapien, commodo in iaculis in, feugiat sed
                                                        enim. </p>
                                                    <br>
                                                    <div class="desc-row">
                                                        <div class="desc-img">
                                                            <img src="images/desc-img1.jpg">
                                                        </div>
                                                        <div class="heading">Stylish and Elegant Design</div>
                                                        <div>
                                                            <p>Featuring a stylish and stunning design, this laptop from
                                                                Vaio is a must-buy device that perfectly complements a
                                                                modern corporate leader’s lifestyle. Aliquam laoreet
                                                                consequat malesuada. Integer vitae diam sed dolor euismod
                                                                laoreet eget ac felis. Donec non erat sed elit bibendum
                                                                sodales. Donec eu cursus velit. Proin nunc lacus, gravida
                                                                mollis dictum ut, vulputate eu turpis. Sed felis sapien,
                                                    ...
                                                    <div class="desc-row">
                                                        <div class="desc-img align-right">
                                                            <img src="images/desc-img2.jpg">
                                                        </div>
                                                        <div class="heading">Lightweight</div>
                                                        <div>
                                                            <p>Thanks to its lightweight build, this laptop makes it easy to
                                                                lift, hold, and open. You can even take it along with you
                                                                wherever you go, making it your ideal travel companion.
                                                                Aliquam laoreet consequat malesuada. Integer vitae diam sed
                                                                dolor euismod laoreet eget ac felis. Donec non erat sed elit
                                                                bibendum sodales. Donec eu cursus velit. Proin nunc lacus,
                                                                gravida mollis dictum ut, vulputate eu turpis. Sed felis
                                                                sapien, commodo in iaculis in, feugiat sed enim. Sed nunc
                                                                ipsum, fermentum varius dignissim vitae, blandit et ante.
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="desc-row">
                                                        <div class="desc-img">
                                                            <img src="images/desc-img4.jpg">
                                                        </div>
                                                        <div class="heading">Easy Connectivity</div>
                                                        <div>
                                                            <p>This laptop comes with a wide range of I/O ports that let you
                                                                connect various compatible devices to it. Moreover, the
                                                                ports are placed on either side of the laptop, making it
                                                                easy for you to connect your compatible mobile/tablet,
                                                                storage drives, external displays, and more. Aliquam laoreet
                                                                consequat malesuada. Integer vitae diam sed dolor euismod
                                                                laoreet eget ac felis. Donec non erat sed elit bibendum
                                                                sodales. Donec eu cursus velit. Proin nunc lacus, gravida
                                                                mollis dictum ut, vulputate eu turpis.</p>
                                                        </div>
                                                    </div>
                                                    <div class="desc-row">
                                                        <div class="desc-img align-right">
                                                            <img src="images/desc-img5.jpg">
                                                        </div>
                                                        <div class="heading">Ergonomic Keyboard and Hinge</div>
                                                        <div>
                                                            <p>Thanks to the ergonomically designed hinge, this laptop's
                                                                screen tilts down at a slanting angle, enabling you to open
                                                                it with ease. The keyboard offers a comfortable typing
                                                                experience, thereby minimizing the load on your hands while
                                                                working. Aliquam laoreet consequat malesuada. Integer vitae
                                                                diam sed dolor euismod laoreet eget ac felis. Donec non erat
                                                                sed elit bibendum sodales. Donec eu cursus velit. Proin nunc
                                                                lacus, gravida mollis dictum ut, vulputate eu turpis. Sed
                                                                felis sapien, commodo in iaculis in, feugiat sed enim. Sed
                                                                nunc ipsum, fermentum varius dignissim vitae, blandit et
                                                                ante.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="product_tabs_tags">
                                                <div class="box-collateral box-spec">
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <th>Sales Package</th>
                                                            <td>Laptop, Power Adaptor, Laptop Bag, User Guide, Warranty
                                                                Documents</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Model Number</th>
                                            ...
                                            <div class="tab-pane fade" id="reviews_tabs">
                                                <div class="woocommerce-Reviews">
                                                    <div>
                                                        <h2 class="woocommerce-Reviews-title">2 reviews for <span>Anti Glare
                                                                Core i5 9th Genration Side Narrow Border Display
                                                                Laptop</span></h2>
                                                                    ...
                                                                    <div class="comment-text">
                                                                        <div class="star-rating">
                                                                            <span style="width:60%">Rated <strong
                                                                                    class="rating">3.00</strong> out of
                                                                                5</span>
                                                                        </div>
                                                                        <p class="meta">
                                                                        ...
                                                                        <div class="description">
                                                                            <p>Vivamus magna justo, lacinia eget consectetur
                                                                                sed, convallis at tellus. Nulla quis lorem
                                                                                ut libero malesuada feugiat. Proin eget
                                                                                tortor risus. Donec rutrum congue leo eget
                                                            ...
                                                            <li class="comment">
                                                                <div>
                                                                    ...
                                                                    <div class="comment-text">
                                                                        ...
                                                                        <div class="description">
                                                                            <p>Donec rutrum congue leo eget malesuada. Lorem
                                            ...
                                            <div class="tab-pane fade" id="product_tabs_custom1">
                                                <div class="product-tabs-content-inner clearfix">
                                                    <div class="faq">
                                                        <ul>
                                                            <li>
                                                                <strong>Is there any issue in display with color shifting?
                                                                    And is the body metallic?</strong>
                                                                <p>Featuring a stylish and stunning design, this laptop from
                                                                    Vaio is a must-buy device that perfectly complements a
                                                                    modern corporate leader’s lifestyle. Aliquam laoreet
                                                                    consequat malesuada. Integer vitae diam sed dolor
                                                                    euismod laoreet eget ac felis. </p>
                                                                <span>Jhon Doe</span>
                                                            </li>
                                                            <li>
                                                                <strong>Is there any heating issue which is not so
                                                                    normal?</strong>
                                                                <p>Donec eu cursus velit. Proin nunc lacus, gravida mollis
                                                                    dictum ut, vulputate eu turpis. Sed felis sapien,
                                                                    commodo in iaculis in, feugiat sed enim. Sed nunc ipsum,
                                                                    fermentum varius dignissim vitae, blandit et ante.</p>
                                                            ...
                                                            <li>
                                                                ...
                                                                <p> Integer vitae diam sed dolor euismod laoreet eget ac
                                                                    felis. Donec non erat sed elit bibendum sodales. Donec
                                                                    eu cursus velit.</p>
                                                                <span>Stephen Doe</span>
                                                            </li>
                                                            <li>
                                                                <strong>It is useful for coding or not?</strong>
                                                                <p>Sed felis sapien, commodo in iaculis in, feugiat sed
                                                                    enim. Sed nunc ipsum, fermentum varius dignissim vitae,
                                                                    blandit et ante.</p>
                                                                <span>Mark Doe</span>
                                                            </li>
                                                            <li>
                                                                <strong>What is the average battery life?</strong>
                                                                <p>Aliquam laoreet consequat malesuada. Integer vitae diam
                                                                    sed dolor euismod laoreet eget ac felis. Donec non erat
                                                                    sed elit bibendum sodales.</p>
                                                                <span>Jhon Doe</span>
                                                            </li>
                                                        </ul>
                                                    </div>
